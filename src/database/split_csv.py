...
def split_csv(path_csv):
    ...
    try:
        ...
        df_region.to_csv('data/processed/sql_splits/region.csv', index=False)
        ...
        df_etat.to_csv('data/processed/sql_splits/etat.csv', index=False)
        ...
        df_localisation.to_csv('data/processed/sql_splits/localisation.csv', index=False)
        ...
        df_date_temps.to_csv('data/processed/sql_splits/date_temps.csv', index=False)
        ...
        df_client.to_csv('data/processed/sql_splits/client.csv', index=False)
        ...
        df_categorie.to_csv('data/processed/sql_splits/categorie.csv', index=False)
        ...
        df_sous_categorie.to_csv('data/processed/sql_splits/sous_categorie.csv', index=False)
        ...
        df_produit.to_csv('data/processed/sql_splits/produit.csv', index=False)
        ...
        df_commande.to_csv('data/processed/sql_splits/commande.csv', index=False)
        ...
        df_ventes.to_csv('data/processed/sql_splits/ventes_split.csv', index=False)
