...
def graphes(Ventes_Catégorie , Ventes_region , profit_segment , top_product , G_moins):
    ...
    try :
        ...
        plt.ylabel("Sales")
        plt.xlabel("Category")
        plt.savefig("data/processed/Ventes_Catégorie")
        ...
        plt.ylabel("Sales")
        plt.xlabel("Region")
        plt.savefig("data/processed/Ventes_region")
        ...
        plt.xlabel("Segment")
        plt.savefig("data/processed/Profit_segment")
        ...
        plt.savefig("data/processed/Top_produits")
        ...
        plt.ylabel("Sales")
        plt.xlabel("Mois")
        plt.savefig("data/processed/Croissance_mensuelle")
